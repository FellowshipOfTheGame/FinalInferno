...
namespace RotaryHeart.Lib.SerializableDictionary {
    public sealed class Constants {
        ...
        public static bool ShowPages {
            get => EditorPrefs.GetBool(ID_SHOW_PAGES, DEF_SHOW_PAGES);
            set => EditorPrefs.SetBool(ID_SHOW_PAGES, value);
        }
        public static bool ShowSize {
            get => EditorPrefs.GetBool(ID_SHOW_SIZE, DEF_SHOW_SIZE);
            set => EditorPrefs.SetBool(ID_SHOW_SIZE, value);
        }
        public static int PageCount {
            get => EditorPrefs.GetInt(ID_PAGE_COUNT, DEF_PAGE_COUNT);
