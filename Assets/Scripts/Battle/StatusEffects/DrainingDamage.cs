        ...
        public override void Remove() {
            if(Source.CurHP > 0 || !isPermanent){
                ...
                if(doubleEdged && Source.CurHP > 0){
                    ...
                    DamageDrained debuff = (DamageDrained)Source.effects.Find(debuff => debuff.GetType() == typeof(DamageDrained) && debuff.Source == Target && debuff.Target == Source);
                    if(debuff != null) debuff.Remove();
